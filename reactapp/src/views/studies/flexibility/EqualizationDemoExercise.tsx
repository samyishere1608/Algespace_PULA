...
import { EqualizationDemo } from "@components/flexibility/equalization/EqualizationDemo.tsx";
...
export function EqualizationDemoExercise(): ReactElement {
        ...
        <div className={"full-page"} style={{ background: "linear-gradient(180deg, var(--blue-background) 0%, #044a6d 100%)", paddingBottom: "1rem" }}>
            ...
            <div className={"flexibility-view__container"}>
                <div className={"flexibility-view__contents"}>
                    ...
                    <p><Trans ns={TranslationNamespaces.Flexibility} i18nKey={FlexibilityTranslations.EQUALIZATION_DEMO_1} /></p>
                    <p>{t(FlexibilityTranslations.EQUALIZATION_DEMO_2)}</p>
                    <EqualizationDemo firstEquation={firstEquation} secondEquation={secondEquation} />
                    <button className={"button primary-button return-study-view-button"} onClick={() => {
                        setFlexibilityStudyDemosCompleted(studyId, CompletedDemo.Equalization);
